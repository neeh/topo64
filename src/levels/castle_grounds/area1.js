...
export function castle_grounds_seg7_collision_level() {
  COL_INIT();
...
export function castle_grounds_seg7_collision_moat_grills() {
  COL_INIT();
  COL_VERTEX_INIT(0x8);
...
export function castle_grounds_seg7_collision_cannon_grill() {
  COL_INIT();
  COL_VERTEX_INIT(0x4);
