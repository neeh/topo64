...
export function inside_castle_seg7_area_3_collision() {
  COL_INIT();
...
export function inside_castle_seg7_collision_ddd_warp() {
  COL_INIT();
...
export function inside_castle_seg7_collision_ddd_warp_2() {
  COL_INIT();
  COL_VERTEX_INIT(0x12);
  COL_VERTEX(5939, -1074, 1587);
