...
export function jrb_seg7_collision_in_sunken_ship_3() {
  COL_INIT();
...
export function jrb_seg7_collision_in_sunken_ship() {
  COL_INIT();
  COL_VERTEX_INIT(0xA);
...
export function jrb_seg7_collision_0700CEF0() {
  COL_INIT();
  COL_VERTEX_INIT(0xA);
  COL_VERTEX(307, 1024, -101);
  COL_VERTEX(307, 819, -101);
...
export function jrb_seg7_collision_in_sunken_ship_2() {
  COL_INIT();
