...
export function ssl_seg7_collision_07028274() {
  COL_INIT();
  COL_VERTEX_INIT(0x8);
  COL_VERTEX(-87, 3, 147);
...
export function ssl_seg7_collision_070282F8() {
  COL_INIT();
  COL_VERTEX_INIT(0x8);
  COL_VERTEX(-102, 0, 51);
...
export function ssl_seg7_collision_07028370() {
  COL_INIT();
...
export function ssl_seg7_collision_070284B0() {
  COL_INIT();
  COL_VERTEX_INIT(0x13);
  COL_VERTEX(100, 0, 151);
  COL_VERTEX(100, 100, 151);
